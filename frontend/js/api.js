...
const ROLE_HOME = {
  ...
  CCASurgicalNurse: '/surgical_nurse.html',
  CCAPalliativeCareSpecialist: '/palliative_care.html',
  CCARadiationOncologist: '/radiation_oncologist.html',
  CCARadiationPhysicist: '/radiation_physicist.html',
  CCARadiologist: '/radiologist.html',
  CCARadiologyTechnician: '/radiology_technician.html',
  CCARadiationTechnologist: '/radiation_technologist.html',
  ...
  CCAInpatientOncologyNurse: '/inpatient_oncology_nurse.html',
  CCAPharmacist: '/oncology_pharmacist.html',
  CCAMDTCoordinator: '/mdt_coordinator.html',
  CCAPatientLiaison: '/patient_liaison.html',
  CCAPatientRelationsExecutive: '/patient_relations_executive.html',
...
const NAV_ITEMS = [
  ...
  { key: 'radiology_technician', label: 'Radiology Technician', href: '/radiology_technician.html', roles: ['Admin', 'CCARadiologyTechnician'] },
  { key: 'radiation_technologist', label: 'Radiation Technologist', href: '/radiation_technologist.html', roles: ['Admin', 'CCARadiationTechnologist'] },
  ...
  { key: 'inpatient_oncology_nurse', label: 'Inpatient Oncology', href: '/inpatient_oncology_nurse.html', roles: ['Admin', 'CCAInpatientOncologyNurse'] },
  ...
  { key: 'patient_relations_executive', label: 'PRE', href: '/patient_relations_executive.html', roles: ['Admin', 'CCAPatientRelationsExecutive'] },
