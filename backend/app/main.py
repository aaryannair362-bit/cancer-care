...
def seed_demo_logins(db: Session):
    ...
    try:
        ...
        demo_accounts = [
            ...
            {
                "role": "CCARadiologyTechnician",
                "email": "radtech@aivana.com",
                "password": "Password@2026!",
                "portal_name": "CCA Oncology OS (Radiology Technician)",
                "target_url": "/radiology_technician.html",
                "description": "Imaging acquisition: identity/study verification, modality/protocol/contrast capture",
            },
            {
                "role": "CCARadiationTechnologist",
                "email": "radiationtech@aivana.com",
                "password": "Password@2026!",
                "portal_name": "CCA Oncology OS (Radiation Technologist)",
                "target_url": "/radiation_technologist.html",
                "description": "Radiation fraction delivery, pre-treatment verification & equipment issues",
            },
            {
                "role": "CCAPathologist",
            ...
            {
                "role": "CCAPatientRelationsExecutive",
                "email": "pre@aivana.com",
                "password": "Password@2026!",
                "portal_name": "CCA Oncology OS (PRE / Patient Relations)",
                "target_url": "/patient_relations_executive.html",
                "description": "Hospital-wide appointment coordination, patient tasks/alerts & activity visibility (non-clinical)",
            },
            {
                "role": "CCAFinancialCounsellor",
                "email": "counsellor@aivana.com",
                "password": "Password@2026!",
                "portal_name": "CCA Oncology OS (Finance / Billing)",
                "target_url": "/patient_financial_services.html",
                "description": "Cancer treatment estimates, government schemes, insurance & preauthorizations",
            },
            {
                "role": "CCABiller",
                "email": "biller@aivana.com",
                "password": "Password@2026!",
                "portal_name": "CCA Oncology OS (Biller)",
                "target_url": "/biller.html",
                "description": "Charge capture, claim tracking & refunds/credit notes",
            },
            {
            ...
            {
                "role": "CCAInpatientOncologyNurse",
                "email": "ipdnurse@aivana.com",
                "password": "Password@2026!",
                "portal_name": "CCA Oncology OS (Inpatient Oncology Nurse)",
                "target_url": "/inpatient_oncology_nurse.html",
                "description": "Ward MAR, nursing flowsheet, transfer/handover & deterioration escalation",
            },
            {
